...
<div class="wrap" id="isarud-hepsiburada-app">
    ...
    <div id="isarud-hb-loading" class="isarud-hb-loading">
        ...
        <?php _e('Hepsiburada bağlantısı kontrol ediliyor...', 'api-isarud'); ?>
    </div>
    ...
    <div id="isarud-hb-not-connected" class="isarud-hb-not-connected" style="display:none;">
        <div class="isarud-hb-empty" style="max-width:600px;margin:0 auto;">
            <h2 style="font-size:24px;margin-bottom:10px;">🛒 <?php _e('Hepsiburada\'a Bağlanın', 'api-isarud'); ?></h2>
            <button type="button" class="button button-primary button-hero" id="isarud-hb-connect-btn" style="background:#ff6000;border-color:#ff6000;font-weight:600;font-size:16px;padding:12px 32px;height:auto;line-height:1.4">
                🔗 <?php _e('Hepsiburada ile Bağlan', 'api-isarud'); ?>
            </button>
            <p style="color:#6b7280;margin-top:15px;font-size:13px;line-height:1.6;">
                <?php _e('Hepsiburada Satıcı Paneli\'nden alacağınız API Anahtarı, API Secret ve Satıcı (Cari) Numaranız ile mağazanızı entegre edebilirsiniz.', 'api-isarud'); ?>
            </p>
        </div>
    </div>
    ...
    <div id="isarud-hb-connect-modal" style="display:none;position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.6);z-index:9999;align-items:center;justify-content:center;">
        <div style="background:#fff;border-radius:12px;max-width:520px;width:90%;padding:30px;box-shadow:0 10px 40px rgba(0,0,0,0.3);max-height:80vh;overflow-y:auto;">
            ...
            <p style="color:#666;font-size:14px;"><?php _e('Hepsiburada\'ya bağlanacak Isarud mağazanızı seçin:', 'api-isarud'); ?></p>
    ...
    <div id="isarud-hb-app" style="display:none;">
        ...
        <div class="isarud-hb-tab-content" data-tab-content="listings">
            <div style="display:flex;justify-content:space-between;align-items:center;margin:15px 0;">
                <h3><?php _e('Hepsiburada Ürünleri', 'api-isarud'); ?></h3>
                <div>
        ...
        <div class="isarud-hb-tab-content" data-tab-content="categories" style="display:none;">
            <div style="display:flex;justify-content:space-between;align-items:center;margin:15px 0;">
                <h3><?php _e('Hepsiburada Kategorileri', 'api-isarud'); ?></h3>
                <button class="button" id="isarud-hb-categories-load"><?php _e('Yükle', 'api-isarud'); ?></button>
            </div>
            <p><?php _e('Hepsiburada kategori ağacını görüntüleyin ve özelliklerini inceleyin.', 'api-isarud'); ?></p>
        ...
        <div class="isarud-hb-tab-content" data-tab-content="stock" style="display:none;">
            ...
            <div class="isarud-hb-card isarud-hb-card-blue">
                ...
                <p><?php _e('Bir ürünün barkodu, stok ve fiyat bilgilerini Hepsiburada\'a gönder.', 'api-isarud'); ?></p>
            ...
            <div class="isarud-hb-card isarud-hb-card-purple" style="margin-top:20px;">
                ...
                <p style="color:#666;font-size:13px;line-height:1.6;margin-bottom:15px;"><?php _e('Bu özellik açıldığında, WooCommerce\'de yeni bir ürün eklediğinizde veya mevcut bir ürünü güncellediğinizde, ürün otomatik olarak tüm aktif pazaryerlerine (Hepsiburada dahil) gönderilir.', 'api-isarud'); ?></p>
                ...
                <p style="color:#999;font-size:12px;margin-top:12px;line-height:1.5;">
                    ...
                    <strong><?php _e('Hepsiburada kategori ve marka eşleştirmeleri', 'api-isarud'); ?></strong>
            ...
            <div class="isarud-hb-card" style="margin-top:20px;">
                <h4>📦 <?php _e('Manuel Toplu Gönderim (WooCommerce → Hepsiburada)', 'api-isarud'); ?></h4>
                <p style="color:#666;font-size:13px;line-height:1.6;margin-bottom:15px;"><?php _e('Tüm WooCommerce ürünlerinizi tek seferde Hepsiburada\'a göndermek için bu butonu kullanın. Sadece kategori ve marka eşleştirmesi tamamlanmış ürünler aktarılır.', 'api-isarud'); ?></p>
                <button class="button button-primary" id="isarud-hb-bulk-export-btn" style="background:#ff6000;border-color:#ff6000;font-weight:600;">
                    🚀 <?php _e('Tüm Ürünleri Hepsiburada\'a Gönder', 'api-isarud'); ?>
                </button>
        ...
        <div class="isarud-hb-tab-content" data-tab-content="cargo" style="display:none;">
            ...
            <p><?php _e('Hepsiburada siparişlerine kargo takip numarası ekleyin.', 'api-isarud'); ?></p>
            <div class="isarud-hb-card isarud-hb-card-blue">
        ...
        <div class="isarud-hb-tab-content" data-tab-content="settings" style="display:none;">
            ...
            <div class="isarud-hb-card">
                <h4><?php _e('Hepsiburada Bağlantı Bilgileri', 'api-isarud'); ?></h4>
                <p><?php _e('Hepsiburada API bağlantınızın durumu ve bilgileri.', 'api-isarud'); ?></p>
                <table class="form-table">
                    <tr>
...
jQuery(function($){
    ...
    $(document).on('click', '.isarud-hb-delete', function(){
        var barcode = $(this).data('barcode');
        if (!confirm('Bu ürün Hepsiburada\'dan silinsin mi? Bu işlem geri alınamaz.')) return;
        $.post(ajaxurl, {
    ...
    $('#isarud-hb-bulk-export-btn').on('click', function(){
        if (!confirm('<?php echo esc_js(__("Tüm WooCommerce ürünleri Hepsiburada'a gönderilecek. Devam edilsin mi?", "api-isarud")); ?>')) return;
        ...
        $.post(ajaxurl, {
            ...
            $btn.prop('disabled', false).html('🚀 <?php echo esc_js(__("Tüm Ürünleri Hepsiburada'a Gönder", "api-isarud")); ?>');
            if (r && r.success) {
